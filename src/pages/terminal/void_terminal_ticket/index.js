...
import { Get_TerminalTicketByID, Put_TerminalTicket } from "../../api/terminal_ticket";
...
export default function Home() {
    ...
    const onFinish = async (values) => {
        try {
            ...
            let ApiResponse = await Get_TerminalTicketByID(values?.id)
...
console.log(error);
    ...
    const columns = [

      {
        ...
        dataIndex: 'transacation_code',
        key: 'transacation_code',
        width: 150,
        render: (dom, entity) => {
            return dom
    ...
    const confirmVoid = async (id) => {
        try {
            let ApiResponse = await Put_TerminalTicket({
                is_void:1, id:id
            })
...

            {
                ...
                !isfetching ?
                    <>
                        ...
                        <div>
                            <h1 className="text-center text-purple-600">Void Terminal Ticket</h1>
                            ...
                            <div className="mt-10">
                                ...
                                >
                                    ...
                                    >
                                        <InputNumber className="w-full" placeholder="Transaction Code"  />
