...
import { Delete_Terminal_Route, Get_Terminal_Route, Post_Terminal_Route, Put_Terminal_Route } from "../../api/terminal_route";
...
export default function Home() {
    ...
    const handleGetData = async () => {
        ...
        try {
            ...
            let ApiResponse = await Get_Terminal_Route()
    ...
    const onFinish = async (values) => {
        try {
            ...
            let ApiResponse = await Post_Terminal_Route({ ...values })
            Setisfetching(true)
    ...
    const handleDelete = async (record) => {
        try {
            ...
            let ApiResponse = await Delete_Terminal_Route(record?.id)
    ...
    const onFinishEdit = async (values) => {
        try {
            let ApiResponse = await Put_Terminal_Route({
    ...
    const columns = [
        ...
        {
            title: 'First Trip Ticket Fare',
            dataIndex: 'first_trip_tiket_fare',
            key: 'first_trip_tiket_fare',
            render: (dom, entity) => {
                return dom
        ...
        {
            title: 'Base Trip Ticket Fare',
            dataIndex: 'base_trip_tiket_fare',
            key: 'base_trip_tiket_fare',
            render: (dom, entity) => {
                return dom
...

        {
            ...
            onClick: async (record) => {
                formEdit.setFieldsValue({
                    ...
                    route: record.route,
                    first_trip_tiket_fare: record.first_trip_tiket_fare,
                    base_trip_tiket_fare: record.base_trip_tiket_fare,
                })
        ...
        <Layout>
...

            {
                ...
                !isfetching ?
                    <>
                        ...
                        <div>
                            <h1 className="text-center text-purple-600">Terminals & Routes</h1>
            ...
            >
                ...
                >
                    ...
                    <Form.Item
                        label="First trip ticket fare"
                        name="first_trip_tiket_fare"
                    ...
                    <Form.Item
                        label="Base trip ticket fare"
                        name="base_trip_tiket_fare"
