              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <Link href="/palengke">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow flex items-center space-x-4">
                    ...
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-300 rounded-xl dark:bg-gray-800">
                      ...
                      <ShoppingCartOutlined className=" text-4xl text-purple-600" />
                    </div>
                ...
                <Link href="/terminal">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow flex items-center space-x-4">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-purple-600">Terminal</p>
                ...
                <Link href="/slaughter">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow flex items-center space-x-4">
                    ...
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-300 rounded-xl dark:bg-gray-800">
                      ...
                      <ShopOutlined className=" text-4xl text-purple-600" />
                    </div>


                    <div>
                      <p className="text-2xl font-bold text-purple-600">Slaughter</p>
                ...
                <Link href="/dashboard/palengke">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow flex items-center space-x-4">
                    ...
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-300 rounded-xl dark:bg-gray-800">
                      ...
                      <UserDeleteOutlined className=" text-4xl text-purple-600" />
                    </div>


                    <div>
                      <p className="text-2xl font-bold text-purple-600">Cemetery</p>
