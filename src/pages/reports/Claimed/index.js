                ...
                !isfetching ?
                    <>
                        <h1 className="text-sm text-center font-semibold">
                            {area?.toLocaleUpperCase()} Claimed Winning Tickets LIST
                        </h1>
                                            ...
                                            <div className="container" key={key}>
                                                ...
                                                <table id=" table">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            <th colSpan={9} className="MyTableBorder font2 text-center">{item.username?.toLocaleUpperCase()}</th>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <th className="MyTableBorder font2 text-center">Claimed Date</th>
                                                        </tr>
                                                    </thead>
                                                            ...
                                                            data?.filter((entity) => {
                                                                ...
                                                                return (
                                                                    <tr className="" key={key2}>
                                                                        ...
                                                                        <td className="MyTableBorder font2 text-right ">{item2?.claimDate}</td>
                                                                    </tr>
